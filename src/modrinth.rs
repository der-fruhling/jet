...
#[derive(Deserialize, Serialize /* embedded in pack */, Debug, PartialEq, Eq)]
...
pub async fn project_version_get(
    ...
    let response = client.get(format!("https://api.modrinth.com/v2/project/{}/version/{}", project, version))
                    .send().await
    ...
    match response.status() {
        StatusCode::OK => {
            ...
            serde_json::from_str::<ProjectVersionGetResponse>(&text)
